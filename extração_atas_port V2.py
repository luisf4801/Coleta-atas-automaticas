...
def baixar_ata(nro_reuniao):
    ...
    try:
        ...
        if textoAta is None:
            ...
            paragrafos=textoAta.split('\n\n')
            p_limpos=[]
            for p in paragrafos:
                p_limpo=limpar_html(p)
                p_limpos.append(p_limpo)
...
test_html=baixar_ata(21)

len(test_html[0]["paragrafos"])
...
print(f"atas extraidas em {end-start} segundos")
...
df_atas.to_excel("C:/Users/Luis/Desktop/tese/dados/ata_bc/base_atas_port_parag.xlsx")


df_atas.to_feather("C:/Users/Luis/Desktop/tese/dados/ata_bc/base_atas_port_parag.feather")
